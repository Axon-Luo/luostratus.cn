(function(){
  ...
  function collectionSeed(name,index){
    const data=[
      ["潮痕短刃","OC-17","十九世纪末","钢、黄铜与旧木","31.4 × 4.8 cm","北岸旧港私人收藏","刀背留有无法辨认的航线刻痕，护手边缘带有长期海水侵蚀形成的浅色结晶。","航海、遗物"],
      ["无日期信件","OC-42","年代未详","棉纸与蓝黑墨水","21 × 14.8 cm","第七码头档案箱","信件没有日期与署名，纸张折痕中残留少量盐粒，正文提到一艘不存在于港务记录中的船。","纸本、书信"],
      ["蓝盐晶体","OC-08","采集于 2026","未知矿物","9.2 × 6.1 cm","灯塔下层储藏室","半透明蓝色晶体在低温环境中会发出微弱荧光，表面具有类似潮汐线的层状纹理。","矿物、标本"]
    ][index%3];
